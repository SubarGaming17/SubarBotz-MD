...
function title() {
	...
	console.log(color(`\n${themeemoji} YT CHANNEL: Manz Stevia OFC`,'magenta'))
console.log(color(`${themeemoji} GITHUB: ManzStevia `,'magenta'))
...
console.log(color(figlet.textSync(`Xrksoo`, {
font: 'Standard',
...
DeepakLft = await getBuffer(ppuser)
                ...
                deepakbody = ` • Hello Bitch @${deepakName.split("@")[0]} 😋 •
Gw *Xcfess Bot*, Selamat Datang Di ${metadata.subject} Junggle😁.

Moga Ga Betah Ya Bre Wkwk😁😁😁😋😋😋`
...
"sourceUrl": `${wagc}`}}})
                    ...
                    deepakbody = `Bye Bitch!, @${deepakName.split("@")[0]} Akhirnya Beban Out Awokawokawok 😋`
DeepakBotInc.sendMessage(anu.id,
 { text: deepakbody,
 contextInfo:{
 mentionedJid:[num],
...
const deepakdate = moment.tz('Asia/Kolkata').format('DD/MM/YYYY')
let deepakName = num
deepakbody = ` Slamet Ya Jadi Admin😒🎉 @${deepakName.split("@")[0]}, you have been *promoted* to *admin* 😒

*Ciaelah Padahal Gw Pen Bikin Di Sengsara Eh Tau² Nya Jdi Admin`
   DeepakBotInc.sendMessage(anu.id,
 { text: deepakbody,
 contextInfo:{
 mentionedJid:[num],
...
const deepakdate = moment.tz('Asia/Kolkata').format('DD/MM/YYYY')
let deepakName = num
deepakbody = `Ups🥵‼️ @${deepakName.split("@")[0]}, you have been *demoted* from *admin* Hahahaha🤭 

*Akhirnya Keinginan Gw Tercapai`
DeepakBotInc.sendMessage(anu.id,
 { text: deepakbody,
 contextInfo:{
 mentionedJid:[num],
